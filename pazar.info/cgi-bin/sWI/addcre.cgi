...
$refid||=0;
$evidid||=0;
my $aid=$pazar->get_primary_key('analysis',$info{userid},$evidid,$params{aname},$methid,$cellid,0,$refid,$params{analysis_desc});
#print 'Adding to analysis ',$aid;
unless ($aid) {
	$aid=$pazar->table_insert('analysis',$info{userid},$evidid,$params{aname},$methid,$cellid,'',$refid,$params{analysis_desc});
}
