...
<b>db_geneinfo=</b>"database:accession:name"; #the database can be either of the following:EnsEMBL Gene, Entrez Gene, RefSeq, SwissProt. Last part (gene name) optional.<br>
</p>
<p><span class="title4">Optional Attributes</span><br>
<b>band=</b>"";<br>
<b>db_transcriptinfo=</b>"database:accession:name"; #the database can be either of the following:EnsEMBL Transcript, RefSeq, SwissProt. Last part (isoform name) optional.<br>
<b>transcript_start=</b>"";<br>
<b>analysis_name=</b>"";<br>
<b>db_tfinfo=</b>"database:accession:name"; #the database can be either of the following:EnsEMBL Transcript, RefSeq, SwissProt.<br>
<b>method=</b>"";<br>
